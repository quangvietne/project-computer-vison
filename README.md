...
- Giải pháp là xây dựng Mô hình Lai (Hybrid Model): sử dụng kiến trúc YOLOv8 làm nền tảng (Head/Neck) và thay thế Backbone mặc định bằng các mạng CNN hiện đại để tối ưu hóa việc trích xuất đặc trưng.
